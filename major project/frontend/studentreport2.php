...
table,th,td{
    ...
    <center>
        ...
        <h1 style="color: rgb(68, 153, 213);">ABC Institute for Science and Technolgies.</h1>
    ...
    ?>
        ...
        padding: 10px 0 10px;
        font-size: 14px;display:block" scrollamount="5" ><span><?php echo $today; ?></span>: Welcome to ABC institutions.</marquee>
<br>
<br>
<br>
<body>
...
$query3 = "select * from studentdetails where studentid='$rollno'";
        ...
        <tbody>
            <?php
                ...
                $query2 = "SELECT studentdetails.studentname, (COUNT(*)*100)/total as Percentage from studentdetails, $rollno,temp where $rollno.status='present'and $rollno.date>='$fromdate' and $rollno.date<='$todate' and studentdetails.studentid='$rollno';";
